...
class EducationCell: UICollectionViewCell {
    ...
    func setupViewLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            tabTitle.topAnchor.constraint(equalTo: tabHolder.topAnchor, constant: 45),
            tabTitle.leadingAnchor.constraint(equalTo: iconImage.trailingAnchor, constant: 5),
            ...
            tabDescription.leadingAnchor.constraint(equalTo: iconImage.trailingAnchor, constant: 5),
